...
lr_svc gets address of the following instruction. This is where the kernel will return to.
SPSR_svc gets CPSR. This saves the mode, condition codes, etc.
CPSR[0:4] gets 0b10011. Supervisor mode.
...
It might be important that there are three link registers. Which three link registers? Why?
In practice it isn't important. Why not? It will be very important later.
Suggestions:
